  ...
  washcombo: [
    {
      id: "1",
      title: "AI 올인원 세탁+건조",
      subtitle: "AI가 알아서 세탁+건조해 준다니 믿어지세요?",
      icon: "Sparkles",
      tag: "올인원",
      mediaType: "video",
    ...
    {
      id: "2",
      title: "국내 최대 25kg 세탁+21kg 건조",
      subtitle: "이불도 한 번에 세탁·건조 가능하다고요?",
      icon: "Maximize2",
      tag: "대용량",
      mediaType: "image",
      ...
      descriptionTitle: "자세히 알아보기",
      description:
        "국내 최대 용량으로 이불, 커튼, 겨울 외투 같은 대형 세탁물도 한 번에 세탁하고 건조할 수 있어요. 가족이 많아도 빨래가 밀리지 않아요.",
      highlights: ["25kg 대용량 세탁", "21kg 대용량 건조", "이불·커튼 케어", "대가족도 충분"],
      disclaimers: ["용량은 세탁물의 종류와 상태에 따라 실제 사용 가능량이 달라질 수 있습니다."],
    },
    {
      id: "3",
      title: "트루스팀",
      subtitle: "100℃ 스팀으로 진짜 깨끗해진다고요?",
      icon: "Wind",
      tag: "트루스팀",
      mediaType: "video",
      mediaUrl: "https://www.lge.co.kr/kr/images/tvs/2026/G6/OLEDG6_02_02_pc_b.mp4",
    ...
    },
    {
      id: "4",
      title: "자동세제",
      subtitle: "세제를 매번 넣을 필요 없이 한 달 치를 한 번에?",
      icon: "Droplets",
      tag: "자동세제",
      mediaType: "image",
    ...
    },
    {
      ...
      galleryImages: [
        ...
        },
        {
          url: "https://static.lge.co.kr/kr/main/caresolution/renew_2206/assets/rmsf2024/s-common/img_washcombo01.jpg",
          title: "미니워시와의 조합",
          description: "속옷이나 운동화 같은 작은 아이템은 미니워시로 별도 케어할 수 있어요.",
        },
      ],
      descriptionTitle: "자세히 알아보기",
      description:
