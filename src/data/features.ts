...
export const featuresMap: Record<string, Feature[]> = {
  ...
  vacuum: [
    ...
    },
    {
      ...
      description:
        "깜박 못 치운 물건 하나에 청소가 멈춰버린 적 있으시죠? AlphaUP Drive는 고립 위험 구역을 스스로 '청소 금지'로 설정해 일단 청소를 끝까지 마칩니다. 다음 청소 때 그 자리에 장애물이 사라진 게 확인되면, 빠뜨린 구역까지 다시 청소해요. 쓸수록 더 꼼꼼해지는 주행입니다.",
