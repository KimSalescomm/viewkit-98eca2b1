...
export const featuresMap: Record<string, Feature[]> = {
  ...
  vacuum: [
    ...
    },
    {
      ...
      tabs: [
        ...
        },
        {
          label: "듀얼 엉킴 방지 브러시",
          description:
            "듀얼 엉킴 방지 브러시가 회전하며 머리카락을 가운데로 모아, 엉킴 걱정 없이 먼지통으로 깨끗하게 흡입해요.",
          highlights: [
            "듀얼 엉킴 방지 브러시",
            "머리카락 흡입구 자동 이동",
            "엉킴 걱정 없이",
      ...
      tabs: [
        {
          label: "히든스테이션",
          description:
            "15cm 초슬림 히든스테이션이 주방의 숨겨진 공간을 가치 있게 활용하도록 도와드려요.\n별도의 공간을 확보할 필요 없이 싱크대 하부 걸레받이에 설치할 수 있고,\n기존 수납공간도 그대로 사용할 수 있어 설치 부담을 덜어드려요.",
          mediaType: "video",
          mediaUrl: "https://wwwstg.lge.co.kr/kr/images/vacuum-cleaners/md10730839/usp2/n95twu_keyvideo_kitchen_pc.mp4",
          highlights: [
            "15cm 초슬림 히든스테이션",
        ...
        },
        {
          label: "오브제스테이션",
          description:
            "공간 맞춤 디자인의 오브제스테이션을 거실 사이드 테이블로 자연스럽게 배치할 수 있어요.\n인테리어에 매끄럽게 스며들어 공간의 품격을 높여줘요.",
      ...
      tabs: [
        {
          label: "100℃ 살균 스팀",
          description:
            "물걸레를 매번 관리하는 번거로움에서 벗어나 보세요.\n냉온수 세척부터 100℃ 살균 스팀까지, 물걸레를 맞춤 세척해 드려요.\n세척이 끝난 후에는 약 40℃ 온풍으로 건조해 물걸레 속 유해균을 효과적으로 제거해요.",
          mediaType: "video",
      ...
      tabs: [
        {
          ...
          mediaType: "image",
          mediaUrl: "/__l5e/assets-v1/8fe1dd11-6cb7-465a-a9ea-57e5e0e11c19/vacuum-security-cert-left.png",
          description: "고객의 데이터를 안전하게 지키는 강력한 LG Shield로 보안 위험을 철저하게 관리해 드려요.\n국가 기관인 개인정보보호위원회의 까다로운 PbD 인증까지 공식 획득하여 불안감 없이 편리하게 이용할 수 있어요.",
        },
        {
          label: "물리적 보안",
          description:
            "우리 집 내부를 비추던 카메라의 시선을 차단할 수 있어요.\n청소를 마치면 자동 도어 닫힘 기능이 렌즈 노출 걱정을 덜어줘요.",
          mediaType: "image",
      ...
      tabs: [
        {
          label: "위생 케어",
          description:
            "물때와 세균 걱정 없이 급수통, 배수통, 필터, 회전솔을 스팀으로 깨끗하게 세척하고,\n전용 관리제로 스테이션 내부 오수관까지 위생적으로 관리해 드려요.",
          mediaType: "image",
          mediaUrl: "https://viewkit.lovable.app/__l5e/assets-v1/d226a096-c139-4360-ac26-3392dec78942/vacuum-subscription-service-01.jpg",
          highlights: [],
        },
    ...
    },
    {
      ...
      description: "사전 구매 고객님께만 드리는 특별한 혜택을 지금 바로 확인해 보세요. 한정 수량과 기간 동안 제공되는 추가 서비스와 사은품으로 더욱 만족스러운 구매 경험을 선사해 드려요.",
      highlights: [],
    },
  ],
