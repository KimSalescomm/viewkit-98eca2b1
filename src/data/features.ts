...
export const featuresMap: Record<string, Feature[]> = {
  ...
  airconditioner: [
    ...
    {
      id: "16",
      title: "어떤 에어컨이 우리 집에 딱 맞을까요?",
      subtitle: "타워·뷰·쿨 시리즈, 주요 스펙을 한눈에 비교해보세요",
      icon: "Ruler",
      tag: "모델별 스펙비교",
      mediaType: "table",
      mediaUrl: "",
...
제품별 스펙은 다를 수 있으니 정확한 내용은 각 제품 상세 스펙을 확인해주세요.",
      ...
      tableData: [
        {
          name: "타워I 9시리즈",
          imageUrl: "https://wwwstg.lge.co.kr/kr/story/buying-guide/2025/img/air-conditioning/img_P01_001_10.jpg",
          specs: [
            { label: "AI콜드프리", values: ["*모델별 상이"] },
            { label: "AI수면", values: ["지원"] },
            { label: "AI음성인식", values: ["지원 (본체/리모컨)"] },
            { label: "AI바람", values: ["지원 (레이더/ 공간인식/ 직접설정)"] },
            { label: "소프트바람", values: ["지원"] },
            { label: "필터클린봇", values: ["지원"] },
            { label: "클린케이스/ 클린토출구", values: ["지원"] },
            { label: "AI 열교환기 세척", values: ["지원"] },
            { label: "AI건조", values: ["지원"] },
            { label: "UV-LED 팬살균", values: ["지원"] },
            { label: "알러지케어 공기청정", values: ["지원 (PM1.0센서)"] },
            { label: "셀프청정", values: ["셀프청정"] },
            { label: "냉방면적", values: ["81.8㎡ / 74.5㎡ / 58.5㎡ *모델별 상이"] },
            { label: "에너지 소비효율 등급", values: ["1등급 / 2등급 *모델별 상이"] },
            { label: "색상", values: ["카밍 베이지 크림 화이트"] },
            { label: "뷰케이스 (별매)", values: ["미지원"] },
            { label: "에어커버 (토출구 자동개폐)", values: ["지원"] },
            { label: "출시연도", values: ["2026"] },
          ],
        },
        {
          name: "타워I 7시리즈",
          imageUrl: "https://wwwstg.lge.co.kr/kr/story/buying-guide/2025/img/air-conditioning/img_P01_001_11.jpg",
          specs: [
            { label: "AI콜드프리", values: ["*모델별 상이"] },
            { label: "AI수면", values: ["지원"] },
            { label: "AI음성인식", values: ["지원 (본체/리모컨)"] },
            ...
            { label: "알러지케어 공기청정", values: ["지원 (PM1.0센서)"] },
            { label: "셀프청정", values: ["셀프청정"] },
            { label: "냉방면적", values: ["58.5㎡ *모델별 상이"] },
            { label: "에너지 소비효율 등급", values: ["2등급"] },
            { label: "색상", values: ["카밍 베이지 크림 화이트"] },
            { label: "뷰케이스 (별매)", values: ["미지원"] },
            { label: "에어커버 (토출구 자동개폐)", values: ["지원"] },
            { label: "출시연도", values: ["2026"] },
        ...
        {
          name: "타워I 5시리즈",
          imageUrl: "https://wwwstg.lge.co.kr/kr/story/buying-guide/2025/img/air-conditioning/img_P01_001_12.jpg",
          specs: [
            { label: "AI콜드프리", values: ["미지원"] },
            { label: "AI수면", values: ["지원"] },
            { label: "AI음성인식", values: ["지원 (본체/리모컨)"] },
            { label: "AI바람", values: ["지원 (레이더/ 공간인식/ 직접설정)"] },
            { label: "소프트바람", values: ["지원"] },
            ...
            { label: "AI건조", values: ["지원"] },
            { label: "UV-LED 팬살균", values: ["지원"] },
            { label: "알러지케어 공기청정", values: ["미지원"] },
            { label: "셀프청정", values: ["셀프청정"] },
            { label: "냉방면적", values: ["81.8㎡ / 58.5㎡ *모델별 상이"] },
            { label: "에너지 소비효율 등급", values: ["2등급"] },
            { label: "색상", values: ["카밍 베이지 크림 화이트"] },
            { label: "뷰케이스 (별매)", values: ["미지원"] },
            { label: "에어커버 (토출구 자동개폐)", values: ["지원"] },
        ...
        {
          name: "뷰I 프로 6시리즈",
          imageUrl: "https://wwwstg.lge.co.kr/kr/story/buying-guide/2025/img/air-conditioning/img_P01_001_13.jpg",
          specs: [
            { label: "AI콜드프리", values: ["*모델별 상이"] },
            { label: "AI수면", values: ["지원"] },
            { label: "AI음성인식", values: ["지원 (리모컨)"] },
            { label: "AI바람", values: ["지원 (레이더/ 공간인식/ 직접설정)"] },
            { label: "소프트바람", values: ["지원"] },
            { label: "필터클린봇", values: ["미지원"] },
            { label: "클린케이스/ 클린토출구", values: ["미지원"] },
            { label: "AI 열교환기 세척", values: ["지원"] },
            { label: "AI건조", values: ["지원"] },
            { label: "UV-LED 팬살균", values: ["*모델별 상이"] },
            { label: "알러지케어 공기청정", values: ["지원"] },
            { label: "셀프청정", values: ["클린뷰"] },
            { label: "냉방면적", values: ["74.5㎡ / 58.5㎡ / 56.9㎡ *모델별 상이"] },
            { label: "에너지 소비효율 등급", values: ["1등급 / 2등급 *모델별 상이"] },
            { label: "색상", values: ["에센스 화이트 카밍 베이지"] },
            { label: "뷰케이스 (별매)", values: ["지원"] },
            { label: "에어커버 (토출구 자동개폐)", values: ["지원"] },
            { label: "출시연도", values: ["2026"] },
          ],
        },
        {
          name: "뷰I 프로 5시리즈",
          imageUrl: "https://wwwstg.lge.co.kr/kr/story/buying-guide/2025/img/air-conditioning/img_P01_001_14.jpg",
          specs: [
            { label: "AI콜드프리", values: ["미지원"] },
            { label: "AI수면", values: ["지원"] },
            { label: "AI음성인식", values: ["지원 (리모컨)"] },
        ...
        {
          name: "뷰I 4시리즈",
          imageUrl: "https://wwwstg.lge.co.kr/kr/story/buying-guide/2025/img/air-conditioning/img_P01_001_15.jpg",
          specs: [
            { label: "AI콜드프리", values: ["미지원"] },
            { label: "AI수면", values: ["지원"] },
            { label: "AI음성인식", values: ["미지원"] },
            { label: "AI바람", values: ["지원 (레이더/ 공간인식/ 직접설정)"] },
            { label: "소프트바람", values: ["지원"] },
            { label: "필터클린봇", values: ["미지원"] },
            { label: "클린케이스/ 클린토출구", values: ["미지원"] },
            ...
            { label: "알러지케어 공기청정", values: ["지원"] },
            { label: "셀프청정", values: ["클린뷰"] },
            { label: "냉방면적", values: ["58.5㎡ / 56.9㎡ *모델별 상이"] },
            { label: "에너지 소비효율 등급", values: ["2등급"] },
            { label: "색상", values: ["에센스 화이트"] },
            { label: "뷰케이스 (별매)", values: ["지원"] },
            { label: "에어커버 (토출구 자동개폐)", values: ["지원"] },
            { label: "출시연도", values: ["2026"] },
          ],
        ...
        {
          name: "뷰I 3시리즈",
          imageUrl: "https://wwwstg.lge.co.kr/kr/story/buying-guide/2025/img/air-conditioning/img_P01_001_16.jpg",
          specs: [
            { label: "AI콜드프리", values: ["미지원"] },
            { label: "AI수면", values: ["지원"] },
            { label: "AI음성인식", values: ["미지원"] },
        ...
        {
          name: "뷰II 2시리즈",
          imageUrl: "https://wwwstg.lge.co.kr/kr/story/buying-guide/2025/img/air-conditioning/img_P01_001_17.jpg",
          specs: [
            { label: "AI콜드프리", values: ["미지원"] },
            { label: "AI수면", values: ["지원"] },
            { label: "AI음성인식", values: ["미지원"] },
            { label: "AI바람", values: ["지원 (공간인식/ 직접설정)"] },
            { label: "소프트바람", values: ["지원"] },
            { label: "필터클린봇", values: ["미지원"] },
            { label: "클린케이스/ 클린토출구", values: ["미지원"] },
            { label: "AI 열교환기 세척", values: ["지원"] },
            { label: "AI건조", values: ["지원"] },
            { label: "UV-LED 팬살균", values: ["미지원"] },
            { label: "알러지케어 공기청정", values: ["지원"] },
            { label: "셀프청정", values: ["클린뷰"] },
            { label: "냉방면적", values: ["58.5㎡ / 56.9㎡ *모델별 상이"] },
            { label: "에너지 소비효율 등급", values: ["3등급"] },
            { label: "색상", values: ["에센스 화이트 카밍 베이지"] },
            { label: "뷰케이스 (별매)", values: ["지원"] },
            { label: "에어커버 (토출구 자동개폐)", values: ["미지원"] },
            { label: "출시연도", values: ["2026"] },
          ],
        },
        {
          name: "뷰II 1시리즈",
          imageUrl: "https://wwwstg.lge.co.kr/kr/story/buying-guide/2025/img/air-conditioning/img_P01_001_18.jpg",
          specs: [
            { label: "AI콜드프리", values: ["미지원"] },
            { label: "AI수면", values: ["지원"] },
            { label: "AI음성인식", values: ["미지원"] },
            ...
            { label: "알러지케어 공기청정", values: ["미지원"] },
            { label: "셀프청정", values: ["클린뷰"] },
            { label: "냉방면적", values: ["62.6㎡ / 58.5㎡ / 56.9㎡ *모델별 상이"] },
            { label: "에너지 소비효율 등급", values: ["3등급"] },
            { label: "색상", values: ["에센스 화이트 카밍 베이지"] },
            { label: "뷰케이스 (별매)", values: ["지원"] },
            { label: "에어커버 (토출구 자동개폐)", values: ["미지원"] },
        ...
        {
          name: "쿨 프로 4시리즈",
          imageUrl: "https://wwwstg.lge.co.kr/kr/story/buying-guide/2025/img/air-conditioning/img_P01_001_19.jpg",
          specs: [
            { label: "AI콜드프리", values: ["미지원"] },
            { label: "AI수면", values: ["지원"] },
            { label: "AI음성인식", values: ["미지원"] },
            { label: "AI바람", values: ["지원 (공간인식/ 직접설정)"] },
            { label: "소프트바람", values: ["미지원"] },
            { label: "필터클린봇", values: ["미지원"] },
            { label: "클린케이스/ 클린토출구", values: ["미지원"] },
            { label: "AI 열교환기 세척", values: ["지원"] },
            { label: "AI건조", values: ["지원"] },
        ...
        {
          name: "쿨 프로 3시리즈",
          imageUrl: "https://wwwstg.lge.co.kr/kr/story/buying-guide/2025/img/air-conditioning/img_P01_001_20.jpg",
          specs: [
            { label: "AI콜드프리", values: ["미지원"] },
            { label: "AI수면", values: ["지원"] },
            { label: "AI음성인식", values: ["미지원"] },
        ...
        {
          name: "쿨 2시리즈",
          imageUrl: "https://wwwstg.lge.co.kr/kr/story/buying-guide/2025/img/air-conditioning/img_P01_001_21.jpg",
          specs: [
            { label: "AI콜드프리", values: ["미지원"] },
            { label: "AI수면", values: ["지원"] },
            { label: "AI음성인식", values: ["미지원"] },
        ...
        {
          name: "쿨 1시리즈",
          imageUrl: "https://wwwstg.lge.co.kr/kr/story/buying-guide/2025/img/air-conditioning/img_P01_001_22.jpg",
          specs: [
            { label: "AI콜드프리", values: ["미지원"] },
            { label: "AI수면", values: ["지원"] },
            { label: "AI음성인식", values: ["미지원"] },
  ...
  vacuum: [
    ...
    },
    {
      ...
      tag: "AI 주행",
      mediaType: "video",
      mediaUrl: "https://wwwstg.lge.co.kr/kr/images/vacuum-cleaners/md10730837/usp/N95THO_03_sensing_ai_driving_pc.mp4",
      description:
