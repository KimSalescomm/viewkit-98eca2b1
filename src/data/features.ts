...
export const featuresMap: Record<string, Feature[]> = {
  ...
  bathair: [
    ...
    },
    {
      ...
      galleryImages: [
        {
          url: "/images/bathair-check-01.jpg",
          title: "CHECK 01",
          description: "기존 환풍기 위치",
        },
        {
          url: "/images/bathair-check-02.jpg",
          title: "CHECK 02",
          description: "멀티 배기형 여부",
        },
        {
          url: "/images/bathair-check-03.jpg",
          title: "CHECK 03",
          description: "천장 구조·재질",
        },
        {
          url: "/images/bathair-check-04.jpg",
          title: "CHECK 04",
          description: "제품 설치 공간",
        },
        {
          url: "/images/bathair-check-05.jpg",
          title: "CHECK 05",
          description: "기타 주의사항",
        },
      ],
