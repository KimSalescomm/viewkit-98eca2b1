...
export const featuresMap: Record<string, Feature[]> = {
      ...
      tabs: [
        {
          ...
          mediaUrl: "https://www.lge.co.kr/kr/story/user-guide/images/basic-spec-vocabulary/quality-list01.mp4",
          description:
            "LCD는 뒤쪽 백라이트가 화면 전체를 비추는 방식이에요. 어두운 장면에서도 빛이 새어 나와 화면이 회색빛으로 보이고, 백라이트·광학시트·편광판·TFT·컬러필터 등 여러 겹의 패널이 겹쳐 있어 구조가 두꺼워요.",
        },
        {
          label: "올레드",
          mediaType: "video",
          ...
          description:
            "OLED는 약 8백만 개의 픽셀 하나하나가 스스로 빛을 내는 방식이에요. 꺼질 땐 완전히 꺼져서 진짜 검정을 표현하고, 백라이트가 없어 패널이 얇고, 어느 각도에서 봐도 색 왜곡이 없어요.",
        },
      ],
      description: "",
      highlights: [
  ...
  refrigerator: [
    {
      ...
      description:
        "STEM 냉장고는 고여 있는 물이 아닌, 흐르는 물로 얼음을 만드는 위생적인 제빙 시스템을 갖추고 있어요.\n게다가 매번 물을 채워 넣을 필요 없이 알아서 얼음이 만들어져 더 편리하게 시원한 시간을 누릴 수 있어요.",
      highlights: [
  ...
  "ai-washtower": [
          ...
          collapsibleDisclaimers: [
            {
              title: "건조 준비 시간 단축",
              items: [
                "'건조준비' 기능은 모든 코스에서 사용 가능하며, 건조 준비 중 예상 건조시간이 건조 시 디스플레이에 표기되는 기능입니다. (건조준비 버튼을 눌러야 하며, 다운로드 코스는 제외)",
                "KATRI 시험 결과, 자사가 제시한 시험기준으로 파자마를 스피드워시 세탁 후 건조준비 옵션을 선택한 후 소량급속 건조 코스로 동작 시, 건조준비 옵션 미적용 대비 세탁+건조시간 평균 65분에서 60분으로 최대 8% 단축",
                "시간 단축효과는 실제 사용환경 및 코스에 따라 다를 수 있음 (다운로드 코스는 제외)",
              ],
            },
            {
              title: "AI 타임 센싱",
      ...
      subFeatures: [
        {
          ...
          mediaType: "video",
          mediaUrl: "https://www.lge.co.kr/kr/images/wash-tower/md10793829/usp/WA2525EGP6Z_ai_time_sensing.mp4",
          disclaimers: [
            {
              title: "AI 타임 센싱",
              items: [
    ...
    },
    {
      ...
      subtitle: "세탁 용량과 동일한 25kg 건조 용량으로 많은 양의 세탁물도 여유롭게\n세탁·건조 할 수 있어요.",
      icon: "Expand",
      tag: "25kg 대용량 세탁·건조",
      mediaType: "video",
      ...
      disclaimers: [
        "소비자의 이해를 돕기 위해 연출된 영상이며, 제품별 색상 및 스펙은 다를 수 있습니다.",
        "국내 최초 · 국내 최대 용량 건조기 : 국내 판매중인 가정용 의류건조기 기준 ('26년 5월 에너지 관리공단 등록 기준)",
        "국내 최대 용량 세탁기 : 국내 판매중인 전기세탁기(드럼) 기준 ('26년 5월 에너지 관리공단 등록 기준)",
      ],
    },
    {
      id: "3",
          ...
          disclaimers: [
            {
              ...
              items: [
                ...
                "HCoV 바이러스는 코로나바이러스의 일종으로 신종 코로나바이러스 19(COVID-19)에 대한 시험 결과가 아님.",
            ...
            },
            {
              ...
              items: [
                "시험 기관 : Environmental Allergens Info and Care Inc.(일본소재) / 시험 일자 : ‘25년 03월",
                "시험 코스 : 알러지케어",
                "시험 부하 : KS C IEC60456 시험기준 국제 규격 부하 4kg",
          ...
          disclaimers: [
            {
              title: "유해세균 살균-건조",
              items: [
                "시험 기관 : UL Solutions, KATRI (한국의류시험연구원) / 시험 일자 : ‘25년 04월",
                "시험 코스 : 스팀살균",
                "시험 부하 : KS C IEC60456 시험기준 국제 규격 부하, UL Solutions 마른상태 4kg / KATRI 마른상태 4kg, 젖은상태 6.5kg",
                "시험 균 : 유해세균 3종 (황색포도상구균, 녹농균, 폐렴간균)",
                "시험 조건 : 시험실 온도 21°±2C, 시험실 습도 50±15% R.H.",
                "시험 방법 : 유해세균 오염된 면직물 부착하여 스팀살균 코스 동작 후 살균력 측정",
                "시험 결과 : 유해세균 3종 99.99% 살균",
                "시험결과는 사용환경 등에 따라 차이가 있을 수 있습니다.",
              ],
            },
            {
              ...
              items: [
                "시험 기관 : KATRI (한국의류시험연구원) / 시험 일자 : ‘25년 03월",
                "시험 코스 : 스팀살균",
                "시험 부하 : KS C IEC60456 시험기준 국제 규격 부하 마른상태 4kg",
                "시험 바이러스 : 바이러스 3종 (인플루엔자 A(H1N1), 아데노(HAdV-C5), 코로나(HCoV-229E)",
                "시험 조건 : 시험실 온도 21°±2C, 시험실 습도 50±15% R.H.",
                "시험 방법 : 바이러스 오염된 면직물 부착하여 스팀살균 코스 동작 후 바이러스 제거 능력 측정",
                "시험 결과 : 바이러스 3종 99.99% 제거",
                "HCoV-229E 바이러스는 코로나바이러스의 일종으로 신종 코로나바이러스 19(COVID-19)에 대한 시험 결과가 아님.",
                "시험결과는 사용환경 등에 따라 차이가 있을 수 있습니다.",
              ],
            },
            {
              ...
              items: [
                "시험 기관 : Environmental Allergens Info and Care Inc. (일본소재) / 시험 일자 : ‘25년 04월",
                "시험 코스 : 스팀살균",
                "시험 부하 : KS C IEC60456 시험기준 국제 규격 부하 마른상태 1.5kg, 젖은상태 2.7kg",
                "시험 알레르겐 : 집먼지진드기 성충, 고양이(Fel d 1), 개(Can f 1), 집먼지진드기(Der f1)",
                "시험 방법 : 집먼지진드기 및 알레르겐이 오염된 면직물 부착하여 스팀살균 코스 동작 후 집먼지진드기 살충 및 알레르겐 제거율 확인",
                "시험 결과 : 집먼지진드기 성충 100% 살충, 고양이(Fel d 1), 개(Can f 1), 집먼지진드기(Der f 1) 알레르겐 99.9% 제거",
                "시험결과는 사용환경 등에 따라 차이가 있을 수 있습니다.",
              ],
            },
            {
              title: "꽃가루 알레르겐 불활성화-건조",
              items: [
                "시험 기관 : Environmental Allergens Info and Care Inc. (일본소재) / 시험 일자 : ‘25년 04월",
                "시험 코스 : 스팀살균코스",
                "시험 부하 : KS C IEC60456 시험기준 국제 규격 부하 마른상태 4.5kg, 젖은상태 7kg",
                "시험 알레르겐 : 삼나무(Cry j 1), 돼지풀(Amb a 1), 자작나무(Bet v 1), 벼과(Phl p 5)",
                "시험 방법 : 꽃가루 알레르겐이 오염된 면직물 부착하여 스팀살균 코스 동작 후 꽃가루 알레르겐 불활성화율 확인",
                "시험 결과 : 삼나무(Cry j 1), 돼지풀(Amb a 1), 자작나무(Bet v 1), 벼과(Phl p 5) 99% 이상 불활성화",
                "시험결과는 사용환경 등에 따라 차이가 있을 수 있습니다.",
              ],
            },
            {
            ...
            },
            {
              ...
              items: [
                "시험 기관 : KATRI (한국의류시험연구원) / 시험 일자 : ‘25년 03월",
                "시험 코스 : 스팀리프레쉬",
                "시험 부하 : KS C IEC60456 표준셔츠 2장, 5장",
                "시험 조건 : 시험실 온도 21°±2C, 시험실 습도 50±15% R.H.",
                "시험 방법 : 자사가 제시한 시험 기준으로, 셔츠 등판 300mm x 300mm 기준 셔츠에 임의 구김을 부여한 후, 셔츠를 무작위로 선택하여 건조기 동작 전, 후 AATCC 시험평가판으로 비교",
                "시험 결과 : 구김정도 시험 전 대비 2배 이상 완화 됨.",
                "시험결과는 사용환경 등에 따라 차이가 있을 수 있습니다.",
              ],
            },
          ],
      ...
      collapsibleDisclaimers: [
        {
          title: "세부정보",
          items: [
            "· 직수/고압세척 적용 모델 : 26년 6월 출시 워시타워 WA2525** 6P* 한정",
            "· Intetek에서 2024년 4월 및 2026년 6월 인공 오염 누적 조건으로 드럼 케어 및 직수/고압 세척의 세척력을 시험한 결과, 직수/고압 세척은 드럼 케어 대비 11% 우수했으며, 2024년 드럼 케어 세척력 기준 환산 시 분해 세척 대비 90% 수준의 세척력을 확인했으나, 세척률 및 오염 정도는 사용 환경에 따라 차이가 있을 수 있습니다.",
            "· 방문 관리는 사전 안내드리고 있으며, 고객 요청에 의해 협의된 일정으로 변경하실 수 있습니다.",
            "\n",
            "· UV 적용 모델 : 26년 6월 출시 워시타워 WA2525** 6P* 한정",
            "\n",
            "· 내시경 카메라 점검 적용 모델 : 26년 6월 출시 워시타워 WA2525** 6P* 한정",
            "\n",
            "· 배수 필터 : 24개월 주기 교체",
            "· 건조 필터 : 최초 방문 시 1회 교체",
            "\n",
            "· 제품 점검 적용 모델 : 26년 6월 출시 워시타워 WA2525** 6P* 한정",
            "\n",
            "· 무상 철거 및 재설치는 가전구독 고객에 한하여 계약기간 내 1회 무상 제공 (운송비 별도) 해드립니다.",
            "· 운송 서비스를 희망할 경우 유상 제공되며 비용은 고객 부담입니다.",
            "· 제품 설치 환경에 따라 추가 비용이 발생할 수 있습니다.",
            "\n",
            "· 무상 A/S는 가전구독 고객에 한하며, 고객 과실로 인한 제품 고장은 제외됩니다.",
          ],
        },
      ],
      mediaGallery: [
  ...
  vacuum: [
    ...
    {
      id: "4",
      title: "우리 집 맞춤 스마트 청소,\n가능할까요?",
      subtitle: "장애물은 알아서 피하고, 놓친 공간까지\n스스로 찾아 청소해요.",
      icon: "Navigation",
      tag: "AI 맞춤 청소",
      mediaType: "video",
      mediaUrl:
  ...
  bathair: [
      ...
      mediaCollapsibleDisclaimers: [
        {
          title: "[온풍]",
          items: [
            "LG ThinQ 앱을 통한 온풍 기능의 원격 제어는 고온 작동에 대한 안전 확보를 위해, 국내외 안전기준에 따라 지원되지 않습니다.",
            "온풍 성능 보증 범위: 실내공간 10℃ ~ 40℃",
            "시험 일시: 25.12.26",
            "시험 기관: LG 전자 자체 시험",
            "시험 대상: M-X0120BAS*",
            "시험 방법: LG전자 실험 챔버(W*D*H(m): 2.3x2.7x2.2) / 풍량 90CMH, 히터 on, 외부온도 19.5℃, 상대 습도 40%, 실내 챔버 온도 19.5℃ / 30분 운전 후 제품 취출구 하단 0.5M에서 온도 측정",
            "시험 결과: 챔버 온도 19.5℃ → 24.5℃ (도달시간 7분)",
        ...
        },
        {
          title: "[공간케어]",
          items: [
            "공간케어 모드는 실내 온·습도 조건에 따라 자동으로 송풍, 온풍, 배기 기능을 제어하여 환경을 유지하는 운전 모드입니다.",
            "시험 일시: 25.12.20",
            "시험 기관: LG 전자 자체 시험",
            "시험 대상: MX0120BAS*, M-X0120BAS*",
            "시험 방법: LG전자 실험 챔버(W*D*H(m): 2.3x2.7x2.2) / 외부 온도 19℃, 외부 습도 40%, 실내 챔버 온도 20.4℃, 실내 챔버 습도 90% → 실내 챔버 습도 60% 도달시간 / 120CMH 풍량, 사용한 풍량은 실내 순환 50% 풍량과 배기 50% 풍량이 합쳐진 풍량임.",
            "시험 결과: 챔버 RH습도 90% → 60% 도달시간 프리미엄듀얼(MX0120BAS*) 7분, 프리미엄(M-X0120BAS*) 12분",
            "제품의 동작 여부와 유지 성능은 설정된 기준 및 사용 환경에 따라 달라질 수 있습니다.",
          ],
        },
        {
          title: "[바디케어]",
          items: [
            "집중된 온풍은 피부 표면에 남아 있는 수분과의 온도 차에 의해 증발 잠열 전달을 촉진하여, 빠른 수분 증발을 유도합니다.",
            "시험 일시: 25.12.08",
            "시험 기관: LG 전자 자체 시험",
            "시험 대상: M-X0120BAS*",
            "시험 방법: LG전자 실험 챔버(W*D*H(m): 2.3x2.7x2.2) / 히터 100% 동작, 실내 챔버 온도 20.0℃ / 10분 후 바람 출구에서 1M 주위온도 대비 상승온도 차를 측정함.",
            "시험 결과: 출구 1M에서, 정격풍량 190CMH에서 주위 온도 대비 14.3℃ 높음",
            "제품의 동작 여부와 유지 성능은 설정된 기준 및 사용 환경에 따라 달라질 수 있습니다.",
          ],
        },
      ],
    ...
    },
    {
      ...
      tag: "가전구독",
      mediaType: "youtube",
      mediaUrl: "https://www.youtube.com/embed/HkCNqxdZ5bs",
      fullWidthMedia: true,
      description:
      ...
      mediaCollapsibleDisclaimers: [
        {
          ...
          items: [
            ...
            "방문 일정은 상황에 따라 변경될 수 있으며 방문 전 케어 전문가가 사전 연락을 드립니다.",
            "무상 A/S는 가전 구독 고객에 한하며, 고객 과실로 인한 제품 고장은 제외됩니다.",
            "자세한 내용은 LGE.COM 내 가전구독 제품별 상세 페이지를 참고해주세요.",
            "채널별 운영하는 모델은 상이할 수 있습니다.",
            "총 계약기간 동안 제품의 소유권은 회사에게 있으며, 재구독은 계약기간 이후에 가능합니다.",
            "분실료 기준 : 제품판매가-{(제품판매가/총 계약기간(개월 수) X 사용 개월 수}, 파손의 경우 분실료의 50% 입니다.",
            "의무 사용기간 내에 해지 시 위약금 등 비용이 발생할 수 있으며 의무 사용기간이 경과하였더라도, 계약기간 이내에 해지할 경우 철거료 등 부대비용이 일부 발생할 수 있습니다.",
            "가전 구독 계약기간 종료 후에는 케어십을 이용하실 수 있습니다.",
            "채널별/지점별 판촉에 따라 할인적용 여부 및 적용가는 상이할 수 있습니다.",
          ],
        },
      ],
    },
  ...
  washcombo: [
    ...
    },
    {
      ...
      highlights: ["국내 최초·국내 최대 세탁건조기", "국내 최대 건조 용량"],
      disclaimers: [
      ...
      collapsibleDisclaimers: [
        {
          ...
          items: [
            "[가전 구독]",
            "워시콤보 가전 구독은 구독 계약 고객에 한해 제공됩니다.",
            ...
            "판매처별/지점별 판촉에 따라 할인적용 여부 및 적용가는 상이할 수 있습니다.",
            "[직수/고압 세척]",
            "적용 모델 : 26년 6월 출시 워시콤보 FC2521**** 한정",
            "Intetek에서 2024년 4월 및 2026년 6월 인공 오염 누적 조건으로 드럼 케어 및 직수/고압 세척의 세척력을 시험한 결과, 직수/고압 세척은 드럼 케어 대비 11% 우수했으며, 2024년 드럼 케어 세척력 기준 환산 시 분해 세척 대비 90% 수준의 세척력을 확인했으나, 세척률 및 오염 정도는 사용 환경에 따라 차이가 있을 수 있습니다.",
            "방문 관리는 사전 안내드리고 있으며, 고객 요청에 의해 협의된 일정으로 변경하실 수 있습니다.",
            "[UV/스팀 케어]",
            "UV 적용 모델 : 26년 6월 출시 워시콤보 FC2521**** 한정",
            "[내시경 카메라 점검]",
            "적용 모델 : 26년 6월 출시 워시콤보 FC2521**** 한정",
            "[필터 세척 및 교체]",
            "배수 필터 : 24개월 주기 교체",
