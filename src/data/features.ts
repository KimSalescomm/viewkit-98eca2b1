  ...
  vacuum: [
    {
      ...
      description:
        "청소로봇이 AI 오염 인식으로 바닥의 마른 얼룩까지 스스로 감지하면,\n스팀 물걸레 청소를 자동으로 시작해요.\n게다가 실시간으로 생성된 100°C 스팀을 물걸레에 직접 분사해 강력하게 닦아내고,\n오염 정도에 따라 최대 2회까지 반복 청소한 뒤,\nThinQ 앱에서 청소 전후 사진까지 비교할 수 있어요.",
