...
export const featuresMap: Record<string, Feature[]> = {
  ...
  vacuum: [
    ...
    },
    {
      ...
      description:
        "복잡한 집안 구조나 예기치 못한 장애물도 똑똑하게 판단하니까 헤맬 걱정이 없어요. 바퀴가 들리거나 갇히기 쉬운 고립 위험 공간을 스스로 학습해 안전하게 회피하고, 게다가 장애물이 치워지면 놓친 곳까지 알아서 다시 찾아가 청소를 완료해 주니 쓸수록 진화하는 편리함을 누릴 수 있어요.",
