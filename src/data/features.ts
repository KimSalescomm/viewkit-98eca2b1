...
export const featuresMap: Record<string, Feature[]> = {
  ...
  airconditioner: [
    ...
    },
    {
      ...
      descriptionTitle: "사용패턴·공간 기반 온도, 기류 제어",
      description:
        "WHISEN AI가 실내 공간과 재실자의 움직임을 감지해 상황에 맞는 바람을 제공합니다.\n\n더울 때는 빠르고 강력한 바람으로 빠르게 시원하게, 시원해지면 미세하고 조용한 한쪽바람·소프트바람으로 부드럽게 유지해요.\n적정 온도에 맞춰 쾌적함을 자동으로 조절하고, 사용 패턴을 학습해 사용자에게 맞는 온도·습도·기류를 스스로 찾아줍니다.",
      highlights: [
        "공간·재실자 감지 맞춤 냉방",
        "더울 땐 빠르고 강력한 바람",
        "쾌적해지면 미세·조용한 소프트바람",
