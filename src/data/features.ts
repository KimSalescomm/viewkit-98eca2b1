...
export const featuresMap: Record<string, Feature[]> = {
  ...
  styler: [
    ...
    },
    {
      ...
      subtitle: "스타일링 전후 오염도 변화를\n숫자로 직접 확인해보세요.",
      icon: "Search",
      tag: "우리 옷, 얼마나 깨끗해질까요?",
      mediaType: "table",
      mediaUrl: "",
      description: "스타일링 전후의 오염도 변화를 비교해, 체감되는 차이를 확인해보세요.",
      highlights: ["미세먼지", "냄새", "구김", "정전기", "관리 시간"],
      tableData: [
        {
          name: "스타일러 케어",
          imageUrl: "",
          specs: [
            { label: "미세먼지", values: ["케어 가능", "(코스/상태에 따라 상이)"] },
            { label: "냄새", values: ["케어 가능", "(의류 소재/오염도에 따라 상이)"] },
            { label: "구김", values: ["완화 도움", "(소재에 따라 상이)"] },
            { label: "정전기", values: ["완화 도움"] },
            { label: "관리 시간", values: ["집에서 간편", "(코스 선택)"] },
          ],
        },
        {
          name: "일반 보관/환기",
          imageUrl: "",
          specs: [
            { label: "미세먼지", values: ["제거 어려움"] },
            { label: "냄새", values: ["부분 완화", "(환기/탈취제 의존)"] },
            { label: "구김", values: ["해결 어려움"] },
            { label: "정전기", values: ["해결 어려움"] },
            { label: "관리 시간", values: ["번거로움", "(반복 필요)"] },
          ],
        },
      ],
    },
    ...
    },
    {
      ...
      mediaType: "gallery",
      mediaUrl: "",
      description: "설치 위치의 치수와 동선, 콘센트 위치에 따라 설치 방식이 달라질 수 있어요. 미리 체크하면 설치가 더 깔끔해집니다.",
