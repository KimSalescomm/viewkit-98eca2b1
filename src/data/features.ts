  ...
  washcombo: [
    {
      ...
      highlightDetails: {
        "AI 타임 센싱": {
          ...
          description:
            "세탁물을 투입 후 문을 닫고 시작 버튼을 누르면 무게를 감지해 약 3초 만에 예상 시간을 알려줍니다. 세탁기 앞에서 오래 기다릴 필요가 없고, 코스 별 시간도 바로 확인할 수 있어 편리해요.",
          mediaType: "video",
    ...
    },
    {
      id: "2",
      title: "실제로 얼마나 편한지\n영상으로 볼 수 있나요?",
      subtitle: "사용 장면을 담은 영상으로\n워시콤보의 편리함을 확인해보세요.",
      icon: "Video",
      tag: "영상",
      mediaType: "youtube",
      mediaUrl: "https://www.youtube.com/watch?v=NOxxvC5cQFw",
      isShorts: false,
      descriptionTitle: "영상으로 확인하는 워시콤보",
      description:
        "세탁부터 건조까지 이어지는 과정과 실제 사용 장면을 영상으로 한눈에 확인하실 수 있어요.",
      highlights: [],
      disclaimers: ["소비자의 이해를 돕기 위해 연출된 영상입니다."],
    },
    {
      id: "3",
      title: "건조까지 빠르게 끝난다고요?",
      subtitle: "인버터 히트펌프로\n옷감 손상은 줄이고 시간은 단축해요.",
      icon: "Zap",
      tag: "히트펌프 건조",
      mediaType: "video",
      ...
      descriptionTitle: "자세히 알아보기",
      description:
        "저온 제습 방식의 인버터 히트펌프가 옷감 손상을 줄이면서 건조 시간을 단축해요. 에너지 사용량도 함께 줄여줍니다.",
      highlights: ["저온 제습 건조", "옷감 손상 최소화", "에너지 효율 개선", "구김 완화 케어"],
      disclaimers: ["건조 시간은 세탁물의 종류와 양, 사용 환경에 따라 달라질 수 있습니다."],
    },
    {
      id: "4",
      title: "우리 집 세탁실에도\n잘 어울릴까요?",
      subtitle: "설치 공간과 디자인을\n사진으로 살펴보세요.",
      icon: "ImageIcon",
      tag: "설치·디자인",
      mediaType: "gallery",
      mediaUrl: "",
      galleryImages: [
        {
          ...
          title: "한 대로 완성되는 세탁실",
          description: "세탁기와 건조기를 따로 두지 않아 공간이 넉넉해져요.",
        },
        {
          url: "https://static.lge.co.kr/kr/main/caresolution/renew_2206/assets/rmsf2024/s-common/img_washcombo03.jpg",
          title: "인테리어와 어우러지는 디자인",
          description: "미니멀한 전면 디자인으로 어떤 공간에도 자연스럽게 어울려요.",
        },
        {
          url: "https://static.lge.co.kr/kr/main/caresolution/renew_2206/assets/rmsf2024/s-common/img_washcombo01.jpg",
          title: "여유로운 도어 개방",
          description: "넓은 도어로 이불 같은 큰 빨래도 편하게 넣고 꺼낼 수 있어요.",
        },
      ],
      descriptionTitle: "자세히 알아보기",
      description:
        "세탁기와 건조기를 따로 두지 않아 세탁실을 훨씬 여유롭게 쓸 수 있어요. 좁은 공간에도 설치할 수 있는 콤팩트한 설계입니다.",
      highlights: ["콤팩트 설치 설계", "미니멀 전면 디자인", "넓은 도어 개방"],
    },
    {
      id: "5",
      title: "워시타워와는 무엇이 다른가요?",
      subtitle: "워시콤보·워시타워·일반 세탁기를\n스펙으로 비교해보세요.",
      icon: "Search",
      tag: "제품 비교",
      mediaType: "table",
      mediaUrl: "",
      mediaSectionTitle: "제품 비교",
      descriptionTitle: "자세히 알아보기",
      description:
        "설치 공간, 세탁·건조 방식, 편의 기능을 비교해 고객에게 알맞은 제품을 안내하세요.",
      highlights: ["설치 공간", "세탁·건조 방식", "케어 서비스", "스마트 기능"],
      tableData: [
        {
          name: "워시콤보",
          imageUrl: "https://static.lge.co.kr/kr/main/caresolution/renew_2206/assets/rmsf2024/s-common/img_washcombo01.jpg",
          specs: [
            { label: "설치 형태", values: ["일체형 1대"] },
            { label: "세탁·건조", values: ["한 대에서 연속"] },
            { label: "빨래 옮김", values: ["필요 없음"] },
            { label: "건조 방식", values: ["인버터 히트펌프"] },
            { label: "구독 케어", values: ["●"] },
          ],
        },
        {
          name: "워시타워",
          imageUrl: "https://static.lge.co.kr/kr/main/caresolution/renew_2206/assets/rmsf2024/s-common/img_washcombo03.jpg",
          specs: [
            { label: "설치 형태", values: ["상·하 결합형"] },
            { label: "세탁·건조", values: ["동시 사용 가능"] },
            { label: "빨래 옮김", values: ["필요"] },
            { label: "건조 방식", values: ["인버터 히트펌프"] },
            { label: "구독 케어", values: ["●"] },
          ],
        },
        {
          ...
          imageUrl: "https://static.lge.co.kr/kr/main/caresolution/renew_2206/assets/rmsf2024/s-common/img_washcombo01.jpg",
          specs: [
            { label: "설치 형태", values: ["단독"] },
            { label: "세탁·건조", values: ["세탁만"] },
            { label: "빨래 옮김", values: ["필요"] },
            { label: "건조 방식", values: ["-"] },
            { label: "구독 케어", values: ["●"] },
          ],
      ...
      disclaimers: [
        "본 비교 내용은 내부 검토용이며, 실제 출시 사양과 다를 수 있습니다.",
      ],
    },
    {
      id: "6",
      title: "관리는 누가 해주나요?",
      subtitle: "정기 점검과 세척까지\n전문가가 알아서 챙겨드려요.",
      icon: "Wrench",
      tag: "구독 케어",
      mediaType: "image",
      ...
      descriptionTitle: "자세히 알아보기",
      description:
        "구독하면 통세척과 성능 점검, 필요 부품 관리까지 전문가가 정기적으로 챙겨드려요. 별도 관리 없이 오래 새 제품처럼 사용할 수 있어요.",
      highlights: ["정기 방문 케어", "통세척·성능 점검", "AS 우선 접수", "월 구독료로 부담 없이"],
      disclaimers: ["케어 서비스 범위와 주기는 구독 상품에 따라 달라질 수 있습니다."],
    },
  ],
