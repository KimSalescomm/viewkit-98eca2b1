...
export const featuresMap: Record<string, Feature[]> = {
  ...
  vacuum: [
    ...
    },
    {
      ...
      description:
        "AlphaUP Drive에 탑재된 고출력 흡입 모터가 최대 30W에 달하는 강력한 흡입력을 발휘합니다. 흡입력(W)은 진공도(kPa)와 유량(ℓ/s)의 곱으로 산정되며, 본 제품의 흡입 모터는 최대 진공도 10,000Pa을 구현해 미세먼지부터 굵은 이물질까지 한 번에 빨아들여요.\n\n여기에 스마트 터보가 더해져 카펫과 같이 청소가 까다로운 바닥재를 스스로 감지하면, 흡입 세기를 한 단계 더 끌어올려 카펫 깊숙한 먼지까지 꼼꼼하게 청소합니다. 강한 출력이 필요할 때만 똑똑하게 힘을 더해, 배터리는 아끼고 청소 결과는 더 깨끗하게 완성해요.",
      highlights: ["최대 30W 흡입력", "최대 진공도 10,000Pa", "스마트 터보 카펫 감지", "바닥재 자동 부스트"],
      disclaimers: [
        "흡입력(Suction Power, W)은 공기 데이터 시험 장비로 측정한 진공도(kPa)와 유량(ℓ/s)의 곱으로 산정됩니다.",
        "최대 진공도 10,000Pa은 유량이 0 ℓ/s인 밀폐된 조건에서 측정한 흡입 모터의 값입니다.",
        "흡입력은 회전 브러시 결합 여부 및 측정 환경에 따라 차이가 있을 수 있습니다.",
      ],
      collapsibleDisclaimers: [
        {
