    ...
    <div className="min-h-screen bg-[hsl(220,20%,97%)]">
      ...
      <main className="max-w-6xl mx-auto px-5 sm:px-8 py-8 sm:py-12">
        ...
        >
          ...
          <p className="text-[15px] sm:text-[16px] font-bold leading-relaxed" style={{ color: "#7C2D12" }}>
            제공되는 케어서비스 항목은 제품별 구독 타입(프리미엄, 라이트, 라이트 플러스 등) 및 구독 모델, 시점에 따라 다를 수 있으므로, 자세한 내용은 구독 계약할 때 반드시 다시 확인해 주세요.
          </p>
        </div>
        ...
        <div className="mt-10 pt-6 border-t border-gray-200">
          <ul className="space-y-1.5 text-[12px] leading-relaxed text-gray-700 whitespace-nowrap overflow-x-auto">
            <li>* 이해를 돕기 위해 연출한 광고적 이미지로, 오염 여부 및 실제 케어서비스 결과는 사용 환경에 따라 다를 수 있습니다.</li>
