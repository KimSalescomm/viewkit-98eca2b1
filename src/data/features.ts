  ...
  vacuum: [
    {
      ...
      description: "바닥에 굳은 마른 얼룩도 이제 직접 닦아낼 필요 없어요. AI가 오염을 인식하면 자동으로 100℃ 실시간 스팀을 분사해 오염 정도에 따라 최대 2회까지 알아서 반복 청소해 주니까요. 청소가 끝난 뒤에는 LG ThinQ 앱으로 깨끗해진 전후 모습까지 눈으로 안심하고 확인할 수 있어 더 편리해요.",
    ...
    },
    {
      ...
      description:
        "RGB 카메라와 센서로 다양한 상황과 장애물을 섬세하게 인식하고 똑똑하게 판단해요.\n헤매거나 구속되었던 공간은 ‘고립 위험 영역’으로 기억해 다음 청소 때 회피하고, 장애물이 사라지면 다시 청소를 재개해요.\n노하우를 쌓아 진화하는 핵심 기술 AlphaUP Drive를 바탕으로 AI 사물 인식 결과를 활용해 공간 특성에 맞춰 청소해 드려요.\n특히 유아용 매트도 문제없도록 최대 2cm 문턱을 가뿐하게 등반해 막힘없이 오가며 청소해 드려요.",
