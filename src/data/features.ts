...
export const featuresMap: Record<string, Feature[]> = {
  ...
  airconditioner: [
    ...
    },
    {
      ...
      subtitle: "\"사설 업체를 부를까?\", \"내가 직접 뜯어서 닦을까?\" 매년 여름 반복되는 리얼한 에어컨 청소 고민! LG전자 에어컨 구독의 전문 케어 서비스(분해세척/UV&피톤치드 케어)로 시원하게 해결해드립니다.",
      icon: "Sparkles",
      tag: "엘숏츠",
      mediaType: "youtube",
  ...
  vacuum: [
    ...
    },
    {
      ...
      description:
        "AlphaUP Drive에 탑재된 고출력 흡입 모터가 최대 30W에 달하는 강력한 흡입력을 발휘합니다. 흡입력(W)은 진공도(kPa)와 유량(ℓ/s)의 곱으로 산정되며, 본 제품의 흡입 모터는 최대 진공도 10,000Pa을 구현해 미세먼지부터 굵은 이물질까지 한 번에 빨아들여요. 스마트 터보가 카펫과 같이 청소가 까다로운 바닥재를 자동 감지하면 흡입 세기를 한 단계 더 끌어올려 깊숙한 먼지까지 꼼꼼하게 청소합니다.\n\n엣지 확장 브러시는 사이드 브러시가 본체 바깥으로 뻗어 나와 벽면과 가구 모서리, 사각지대의 먼지를 안쪽으로 쓸어 모아 흡입구로 보냅니다. 원형 본체의 한계를 넘어 벽 코너까지 닿는 청소 동선을 완성해요.\n\n듀얼 엉킴 방지 브러시는 두 개의 브러시가 반대 방향으로 맞물려 회전하면서, 머리카락과 반려동물 털을 감기지 않게 분리해 곧바로 먼지통으로 보냅니다. 청소 후 브러시에서 머리카락을 뜯어내는 번거로움 없이 먼지통만 비우면 끝, 유지 관리가 한결 간편해져요.",
      highlights: [
      ...
      collapsibleDisclaimers: [
        {
          ...
          items: [
            ...
            "본체에 연결된 흡입 모터를 공기 데이터 시험 장비에 바로 연결한 상태로 흡입 모터 최대 진공도를 측정했습니다.",
            "스마트 터보 설정은 LG ThinQ 앱에서 켜고 끌 수 있으며, 카펫 재질에 따라 감지 성능은 차이가 있을 수 있습니다.",
            "모가 얇거나 20mm 이상의 카펫은 손상될 수 있으므로 정리 후 사용을 권장합니다.",
          ],
        },
        {
          title: "엣지 확장 브러시 / 듀얼 엉킴 방지 브러시 안내",
          items: [
            "엣지 확장 브러시의 확장 거리와 청소 성능은 가구 배치, 벽 형상 등 사용 환경에 따라 차이가 있을 수 있습니다.",
            "24. 6월 인터텍(Intertek) 시험 결과, 자사 제시 기준으로 마룻바닥에 길이가 다른 머리카락 40개를 도포한 후 터보 모드로 흡입 청소하였을 때 메인 브러시에 감기는 머리카락 개수가 5% 이하임을 확인하였습니다.",
            "엉킴 방지 성능은 머리카락 길이·굵기, 반려동물 털의 종류, 실사용 환경에 따라 차이가 있을 수 있습니다.",
