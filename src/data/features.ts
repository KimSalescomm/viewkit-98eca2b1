...
export const featuresMap: Record<string, Feature[]> = {
  ...
  vacuum: [
    ...
    },
    {
      ...
      description:
        "복잡한 집안 구조나 예기치 못한 장애물도 똑똑하게 판단하니까 헤맬 걱정이 없어요.\n바퀴가 들리거나 갇히기 쉬운 고립 위험 공간을 스스로 학습해 안전하게 회피하고, 게다가 장애물이 치워지면 놓친 곳까지 알아서 다시 찾아가 청소를 완료해 주니 쓸수록 진화하는 편리함을 누릴 수 있어요.",
      highlights: ["RGB 카메라·센서 기반 인식", "고립 위험 영역 학습", "장애물 사라지면 청소 재개", "쓸수록 진화하는 청소"],
    },
    {
      id: "3",
      title: "스테이션",
      subtitle: "우리 집엔 어떤 게 어울릴까요? 우리 집 공간에 딱 맞춘 두 가지 타입의 프리미엄 스테이션을 비교해보세요.",
    ...
    },
    {
      ...
      highlights: ["카메라 시선 완벽 차단", "청소 후 자동 도어 닫힘", "렌즈 노출 걱정 없이 안심", "프라이빗 공간 확보"],
    },
    {
      id: "7",
      title: "구독, 더 편해질까요?",
