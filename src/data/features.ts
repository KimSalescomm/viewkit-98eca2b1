  ...
  vacuum: [
    {
      ...
      subtitle: "AI 오염 인식으로 자동으로 바닥 오염물을 알아서 닦아주는 편리한 스팀 물걸레 청소를 경험해보세요.",
      icon: "Flame",
      tag: "스팀 물걸레",
      mediaType: "video",
      mediaUrl: "https://static-stg.lge.co.kr/kr/images/vacuum-cleaners/md10730837/usp/N95THO_02_moving_steam_pc.mp4",
      description: "바닥에 굳은 마른 얼룩도 이제 직접 닦아낼 필요 없어요. AI가 오염을 인식하면 자동으로 100℃ 실시간 스팀을 분사해 오염 정도에 따라 최대 2회까지 알아서 반복 청소해 주니까요.\n청소가 끝난 뒤에는 LG ThinQ 앱으로 깨끗해진 전후 모습까지 눈으로 안심하고 확인할 수 있어 더 편리해요.",
    ...
    },
    {
      ...
      description:
        "복잡한 집안 구조나 예기치 못한 장애물도 똑똑하게 판단하니까 헤맬 걱정이 없어요.\n바퀴가 들리거나 갇히기 쉬운 고립 위험 공간을 스스로 학습해 안전하게 회피하고,\n게다가 장애물이 치워지면 놓친 곳까지 알아서 다시 찾아가 청소를 완료해 주니\n쓸수록 진화하는 편리함을 누릴 수 있어요.",
      highlights: ["RGB 카메라·센서로 장애물 인식", "공간 특성에 맞춰 스마트 청소", "유아용 매트 2cm 문턱 가뿐 등반", "노하우를 쌓아 진화하는 청소"],
    },
    {
      id: "3",
      ...
      tabs: [
        {
          label: "히든스테이션",
          description:
            "15cm 초슬림 히든스테이션은 주방의 숨겨진 약 공간을 가치 있는 공간으로 바꿔요.\n별도의 공간을 확보할 필요 없이 싱크대 하부 걸레받이에 설치할 수 있어요.\n기존 싱크대 수납도 그대로 사용할 수 있어 설치 부담은 줄여요.",
          mediaType: "video",
          mediaUrl: "https://wwwstg.lge.co.kr/kr/images/vacuum-cleaners/md10730839/usp2/n95twu_keyvideo_kitchen_pc.mp4",
          highlights: [
            "15cm 초슬림 히든스테이션",
      ...
      tabs: [
        {
          label: "100℃ 살균 스팀",
          description:
            "급·배수통부터 필터, 회전솔까지 강력한 스팀으로 꼼꼼하게 살균 세척해 줄 뿐만 아니라, 전용 관리제로 보이지 않는 스테이션 내부 오수관까지 알아서 깨끗하게 세척해 주니 매번 신경 쓰지 않고도 언제나 안심하고 위생적으로 사용할 수 있어요.",
          mediaType: "video",
    ...
    },
    {
      ...
      tag: "사전 예약 판매",
      mediaType: "image",
      mediaUrl: "/__l5e/assets-v1/fb16f88a-21f3-4adb-8770-25e56d340d61/vacuum-benefits-clean.png",
      description:
        "사전 예약 고객을 위한 특별한 구매 혜택이 준비되어 있어요.\n\n사전 일시불 구매 시 웰컴키트를 증정해드리고, 사전 구독 신청 시 월 1,400원 할인 혜택을 드려요.\n\nLGE.COM 앱 전용 총 50만원 쿠폰팩과 카드사 결제일 할인 최대 10%, 그리고 최대 12개월 무이자 혜택까지 놓치지 마세요.\n\n포토리뷰 작성 후 렉슨 조명도 신청할 수 있어요.",
      highlights: [
        "사전 일시불 구매 웰컴키트 증정",
        "사전 구독 월 1,400원 할인",
        "포토리뷰 후 렉슨 조명 신청",
        "LGE.COM 앱전용 총 50만원 쿠폰팩",
        "카드사 결제일 할인 최대 10%",
        "무이자 혜택 최대 12개월",
      ],
      collapsibleDisclaimers: [
