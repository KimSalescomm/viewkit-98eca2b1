...
export const productCardConfig: Record<string, ProductCardConfig> = {
  bathair: {
    ...
    cards: {
      ...
      "5": {
        image: "https://www.lge.co.kr/kr/usp_dcr/Bath%20Air%20System/bathair_review_01.jpg",
        eyebrow: "설치 사례",
      },
      "7": {
  ...
  "ai-washtower": {
    ...
    cards: {
      "1": {
        image: "/__l5e/assets-v1/b2aa3acd-dcfa-42a4-aa1c-7261913de6a3/ai-washtower-feature1-poster.png",
        eyebrow: "AI 세탁·건조",
      },
      "2": {
