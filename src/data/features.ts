  ...
  vacuum: [
    ...
    },
    {
      ...
      highlights: [
        "강력한 30W 흡입력",
        "카펫 속 숨어 있는 먼지까지 흡입",
        "엣지 확장 물걸레로 벽면 가장자리까지 밀착해 구석구석 청소해요",
        "듀얼 엉킴 방지 브러시가 회전하며 머리카락을 흡입구 쪽으로 밀어내요",
      ],
      tabs: [
        {
          label: "30W 강력 흡입력",
      ...
      tabs: [
        {
          label: "히든스테이션",
          description:
            "약 15cm 높이의 초슬림 히든스테이션은 별도의 전용 수납장을 마련할 필요 없이,\n싱크대 하단 걸레받이에 설치할 수 있어요.\n기존 싱크대 수납 공간도 그대로 사용할 수 있어 설치 부담은 줄이고,\n자동 급배수까지 편리하게 사용할 수 있어요.",
          mediaType: "video",
          mediaUrl: "https://wwwstg.lge.co.kr/kr/images/vacuum-cleaners/md10730839/usp2/n95twu_keyvideo_kitchen_pc.mp4",
          highlights: [
            "약 15cm 높이의 초슬림 히든스테이션",
            "싱크대 하단 걸레받이에 설치돼요",
            "기존 수납 공간을 그대로 사용할 수 있어요",
            "자동 급배수 전용 스테이션이에요",
          ],
        },
        {
